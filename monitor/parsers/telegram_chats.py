...
MONITORED_CHATS = [
    ...
    # Юридические каналы (право, арбитраж, контракты)
    "pravochina",             # Право Китая — китайское право, законы КНР
    "east_veter",             # Восточный ветер — российско-китайское юрид. общество
    "CentrVED",               # ЦентрВЭД — импорт, экспорт, таможня, сертификация
    "china_forum",            # Китай форум / чат КНР
    "daokedao",               # Китайская угроза — аналитика по Китаю
]
